...
public class Strategy {
	...
	public static void Execute()
	{
		...
		while(repeat)
		{
			...
			if(go == 'y' || go == 'Y'){  
				repeat = true; 
				   //break; //break will exit your code, you don't want to do this, you want to allow repeat to be assigned, that will break out of code.   
				  }  
				  else if(go == 'n' || go == 'N'){  
					  repeat = false;
			...
			//strategyInput.close(); //Errors out if you add closed here. Not really nessary. 
			//strategyExitInput.close();
		}				
	}
